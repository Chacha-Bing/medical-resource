...
import {get_hos_point, slice_hos_point, get_fever_point, search_hos_point, search_accurate_hos, search_distance_point} from 'network/hos_poi.js'
...
var option;
export default {
	// @page1_slice 和@page1不同的是，这里使用了数据分片
	name: 'page1_slice',
	components: {
		searchBar,
		detailBox,
	...
	methods: {
		...
		// 		})
		// 	}
		// 	this.showObj.firstShow[1].push(...hospital_poi);
